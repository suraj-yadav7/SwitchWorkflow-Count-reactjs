        ...
        <>
            <div className='dailyTarget'>
                <div class="card card2" >
                    <div className="radioBtn" style={{margin: "2px", }}>
                        <input type='radio' name="LCB" value="LCB"/>LCB
                        <input type='radio' name="CB" value="CB"/>CB
                        <input type='radio' name="CAB" value="CAB"/>CAB
                        <input type='radio' name="CAB" value="KEP"/>KEP
                    </div>
