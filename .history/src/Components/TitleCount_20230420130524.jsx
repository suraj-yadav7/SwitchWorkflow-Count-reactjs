        ...
        <nav>
            ...
            <div className="container1">
                <div className="card" style={{width: "18rem"}}>
                    <input type='text' name="lcbCount" defaultChecked={true} value={lcbCount}/>
                ...
                <div className="card" style={{width: "18rem"}}>
                    <input type='text' name="cabCount" defaultChecked={true} value={cabCount}/>
                    <div className="card-body">
                ...
                <div className="card" style={{width: "18rem"}}>
                    <input type='text' name="cbCount" defaultChecked={true} value={cbCount}/>
                    <div className="card-body">
