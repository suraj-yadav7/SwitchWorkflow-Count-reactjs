...
const DailyTarget = () => {
        ...
        const targetHandle = (e) =>{
            if(radioBtn === "LCB"){
                ...
                let output = (442-((parseInt((target.npt/1.085).toFixed())) + parseInt((target.icq/6).toFixed())))
                setTarget((prev)=>({...prev,targ:output}))
            }
            ...
            <div className='dailyTarget'>
                <div class="card card2" >
                    ...
                    <div className="radioBtn" style={{margin: "10px"}}>
                        ...
                        <h5 class="card-title cardText">Daily Target Count</h5>
                        <span>Todays Target</span><h3 className='cardText'>{target.targ<=0?0:target.targ}</h3>
                        <span>Meeting/ NPT/ KMT</span><input type='text' name="npt"  onChange={inputVal1} />
                        <span>ICQ / LCB / CAB / CB</span><input type='text' name="icq"  onChange={inputVal2} />
