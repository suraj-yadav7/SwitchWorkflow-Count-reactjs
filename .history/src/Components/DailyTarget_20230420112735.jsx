            ...
            <div className='dailyTarget'>
                <div class="card card2" >
                    ...
                    <div className="radioBtn" style={{margin: "10px"}}>
                        ...
                        <h5 class="card-title cardText2">Daily Target Count</h5>
                        <span style={{fontSize: "1.5rem", marginTop:"10px"}}>Today's Target</span><h3 className='cardText2'>{target.targ<=0?0:target.targ}</h3>
