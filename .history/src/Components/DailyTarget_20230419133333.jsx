            ...
            <div className='dailyTarget'>
                <div class="card card2" >
                    <div className="radioBtn">
                        <input type='radio' name="LCB" value="LCB">LCB</input>
                        <input type='radio' name="CB" value="CB">CB</input>
                        <input type='radio' name="CAB" value="CAB">CAB</input>
                        <input type='radio' name="CAB" value="KEP">KEP</input>
                    </div>
