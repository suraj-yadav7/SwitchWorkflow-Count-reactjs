        ...
        <>
            <div className='dailyTarget'>
                <div class="card card2" >
                    ...
                    <div className="radioBtn" style={{margin: "5px", }}>
                        <input type='radio' name="workFlow" value="LCB"/>LCB
                        <input type='radio' name="workFlow" value="CB"/>CB
                        <input type='radio' name="workFlow" value="CAB"/>CAB
                        <input type='radio' name="workFlow" value="KEP"/>KEP
                    </div>
