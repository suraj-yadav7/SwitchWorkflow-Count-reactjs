            ...
            <div className='dailyTarget'>
                <div className="card card2" >
                    ...
                    <div className="radioBtn" style={{margin: "10px"}}>
                        ...
                        <span>Meeting/ NPT/ KMT</span><input type='number' name="npt" className='inputArea' onChange={inputVal1} />
                        <span>ICQ / LCB / CAB / CB</span><input type='number' name="icq"  className='inputArea' onChange={inputVal2} />
