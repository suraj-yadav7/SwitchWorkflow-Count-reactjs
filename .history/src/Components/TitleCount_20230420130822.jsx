        ...
        <nav>
            ...
            <div className="container1">
                <div className="card" style={{width: "18rem"}}>
                    <input type='text' name="lcbCount" readOnly="readonly"  value={lcbCount}/>
                ...
                <div className="card" style={{width: "18rem"}}>
                    <input type='text' name="cabCount" readOnly="readonly" value={cabCount}/>
                    <div className="card-body">
                ...
                <div className="card" style={{width: "18rem"}}>
                    <input type='text' name="cbCount" readOnly="readonly" value={cbCount}/>
                    <div className="card-body">
